...
client.on('message', message => {
    ...
    if (message.content === 'nephelp') {
    	message.channel.send('Nep ! : nephelp, nepgit, nepu, nepgya, nepkappa, neppraise, nepballon, nepgud, nepangry, nepuganda, nepuvult, neptroll, nepthalassa, neplewd, nepcome.');
  	}
    ...
    if (message.content === 'nepballon') {
        message.channel.send("", {files:["https://raw.githubusercontent.com/rouant/nepu-bot-stockage/master/pics/nepballoon.png"]});
    }
});
